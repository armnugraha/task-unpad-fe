                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            <div class="float-left">
                                <i class="fa fa-clock-o icon-lg"></i>
                            </div>
                            <div class="float-right">
                                <p class="card-text text-right font-weight-bold">Absensi</p>
                                <!-- <p class="card-title font-weight-bold text-center mb-0">Jam Masuk 09.00 - 11.00</p> -->
                            </div>
                        </div>
                        <hr>            
                        <!-- <p class="card-title font-weight-bold">Absen akan dibuka 15 menit sebelum waktu dimulai, dan akan ditutup 15 menit setelah pelajaran dimulai</p> -->
                        <a href="http://localhost:7002/face_matching" target="_blank" class="text-white"><i class="fa fa-chevron-circle-right text-white" aria-hidden="true"></i> Absen</a>
                    </div>
                </div>
            </div>
<?php
...
<br>
  ...
  <!-- INFORMASI MENGENAI MATERI terpost -->
   ...
   WHERE tb_roleguru.id_kelas='$_SESSION[kelas]' AND tb_roleguru.id_jurusan='$_SESSION[jurusan]' AND public='Y' ORDER BY tb_materi.id_materi DESC LIMIT 5 ");
...
<form action="?page=chat" method="post">
  <div class="form-group">
    ...
    $sqlrole=mysqli_query($mysqli, "SELECT * FROM tb_roleguru
            WHERE id_kelas='$_SESSION[kelas]' AND id_jurusan='$_SESSION[jurusan]' ");
